      ...
      <Row>
        <Col md="4">
          <h6
            ...
            className='mx-0 py-3'
          ><span className={`mx-0 py-3 cursor-pointer ${searchOrFrequentlyUsed === 'search' ? 'active-allOrCompleted' : ''}`}>
        ...
        <Col md="5">
          <h6
            onClick={toggleFreq}
            className='mx-0 py-3'>
            <span className={`mx-0 py-3 cursor-pointer ${searchOrFrequentlyUsed === 'frequentlyUsed' ? 'active-allOrCompleted' : ''}`}>
